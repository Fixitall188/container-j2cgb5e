...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j2cgb5e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j2cgb5e.containers.anotherwebservice.com/
...
```
git clone git@github.com:Fixitall188/container-j2cgb5e.git
cd container-j2cgb5e
```
...
```
docker attach container-j2cgb5e
```
